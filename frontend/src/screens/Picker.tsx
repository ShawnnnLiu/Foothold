    ...
    <div className="picker">
      ...
      <div className="picker__pickers">
        <div className="picker__pick">
          <span className="picker__label">COMMUNITY COLLEGE</span>
          <select
            className="picker__select picker__select--cc"
            value={sendingId}
        ...
        <span className="picker__arrow">→</span>
        <div className="picker__pick">
          <span className="picker__label">TARGET UNIVERSITY</span>
          <select
            className="picker__select picker__select--target"
            value={receivingId}
        ...
        <div className="picker__pick">
          <span className="picker__label">MAJOR</span>
          <select
            className="picker__select picker__select--major"
            value={majorKey}
      ...
      <div className="picker__demo">
        <span className="picker__demo-hint">No transcript handy?</span>
        <FoilButton
          size="md"
          finish="rainbow"
      ...
      <div className="picker__stats">
        <div className="picker__stat">
          <span className="picker__gao">
            Transfer students lose an average of 43% of their credits
          </span>{" "}
          <span className="picker__gaoref">(GAO-17-574)</span>
        </div>
        <div className="picker__scale">
